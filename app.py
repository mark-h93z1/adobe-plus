#!/usr/bin/env python3
"""adobe-plus GUI — visual updater for adobe."""
...
class GUI:
 def __init__(self):
 self.root = tk.Tk()
 self.root.title("adobe-plus")
 self.root.geometry("500x400")
 self.root.resizable(False, False)

 # Header
 ttk.Label(self.root, text="adobe-plus", font=("Arial", 16, "bold")).pack(pady=10)
 ttk.Label(self.root, text="Adobe Configuion Tool").pack()
